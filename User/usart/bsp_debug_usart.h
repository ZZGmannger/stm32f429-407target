...
#define CMD_USART_RX_GPIO_CLK                 RCC_AHB1Periph_GPIOD
#define CMD_USART_RX_PIN                      GPIO_Pin_6
#define CMD_USART_RX_AF                       GPIO_AF_USART2
#define CMD_USART_RX_SOURCE                   GPIO_PinSource6

#define CMD_USART_TX_GPIO_PORT                GPIOD
#define CMD_USART_TX_GPIO_CLK                 RCC_AHB1Periph_GPIOD
#define CMD_USART_TX_PIN                      GPIO_Pin_5
#define CMD_USART_TX_AF                       GPIO_AF_USART2
#define CMD_USART_TX_SOURCE                   GPIO_PinSource5
